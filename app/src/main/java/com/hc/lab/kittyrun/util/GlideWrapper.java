...
public class GlideWrapper {
    ...
    public static void loadGiftRes(final Context context, final GiftModel giftModel, final OnGiftResLoadListener loadListener) {
        Glide.with(context).load(giftModel.giftIcon).asBitmap().into(new SimpleTarget<Bitmap>() {
            ...
            public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                ...
                loadNextGiftRes(context, giftModel, loadListener, bmp);
            }
    ...
    private static void loadNextGiftRes(final Context context,
                                        ...
                                        final Bitmap bitmap) {
        Glide.with(context).load(giftModel.senderAvatar).asBitmap().into(new SimpleTarget<Bitmap>() {

...
/*
    ...
    /* surface, different than screen size */
    private CGSize surfaceSize_;

    /* screenSize , the size of cellphone screen*/
    private CGSize winSize_;
...
//        }
    ...
    public CGPoint convertToGL(CGPoint uiPoint) {
        float newX = uiPoint.x / winSize_.width * screenSize_.width;
        float newY = screenSize_.height - uiPoint.y / winSize_.height * screenSize_.height;
    ...
    public void convertToGL(float uiX, float uiY, CGPoint ret) {
        float newX = uiX / winSize_.width * screenSize_.width;
        float newY = screenSize_.height - uiY / winSize_.height * screenSize_.height;
